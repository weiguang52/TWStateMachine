...
bool robot_msg__msg__speech_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_msg.msg._speech_data.SpeechData", full_classname_dest, 37) == 0);
  }
  robot_msg__msg__SpeechData * ros_message = _ros_message;
  {  // audio_data
...
{
  /* NOTE(esteve): Call constructor of SpeechData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_msg.msg._speech_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SpeechData");
