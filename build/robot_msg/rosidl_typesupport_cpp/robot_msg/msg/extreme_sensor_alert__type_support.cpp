...
static const _ExtremeSensorAlert_type_support_symbol_names_t _ExtremeSensorAlert_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msg, msg, ExtremeSensorAlert)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_msg, msg, ExtremeSensorAlert)),
  }
};
...
{
  return &::robot_msg::msg::rosidl_typesupport_cpp::ExtremeSensorAlert_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_msg, msg, ExtremeSensorAlert)() {
  return get_message_type_support_handle<robot_msg::msg::ExtremeSensorAlert>();
}
